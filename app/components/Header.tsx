...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Hidden di Mobile (hidden), Tampil di Desktop (md:block) */}
      ...
      {/* --- 2. HEADER MOBILE (Logo Saja di Atas) --- */}
      {/* Tampil di Mobile (block), Hidden di Desktop (md:hidden) */}
      <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-sm shadow-sm md:hidden px-4 py-3 flex justify-between items-center">
         ...
         {/* Login Button Mobile (Versi Kecil) */}
         {!loading && !user && (
      ...
      {/* Fixed di bawah layar, hanya muncul di layar kecil (md:hidden) */}
...
// --- KOMPONEN IKON SVG (Inline agar ringan) ---
